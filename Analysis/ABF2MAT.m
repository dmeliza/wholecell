function r0 = abf2mat(filename, episodeInterval, channels)
% ABF2MAT: reads in an Axon Binary File and returns the values in a format
% usable by matlab:
%
% r0 =  abf2mat(filename, episodeInterval, [channels])
%
...
gain        = pc8h.fADCRange / pc8h.lADCResolution ./ pc8h.fGain(1:channels);
offset      = pc8h.fSignalOffset(1:channels);
...
t_rate = 1000000/pc8h.fADCSampleInterval / channels;
fprintf('File %s contains %i channels with %i samples at %i /s\n',...
    filename, channels, samples, t_rate);
